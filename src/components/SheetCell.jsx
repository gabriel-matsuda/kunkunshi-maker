...
export default function SheetCell({ colIndex, rowIndex, cell, isSelected, note2Active, onClick, onNote2Click, onChorusToggle, onContextMenu, onInsertCell, onRemoveCell }) {
